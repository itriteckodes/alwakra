              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () async {
                        if (!Api.validateImage(headerController.text, contentController.text, imageString)) {
                          EasyLoading.showError("Please fill all fields");
                          return;
                        }
                        EasyLoading.show(status: 'Please Wait');
                        var result = await Api.submitImages(headerController.text, contentController.text, imageString);
                        if (result) {
                          setState(() {
                            image = null;
                            intListImage = null;
